...
bfi_cn <- read_csv("data/chinese-adaptation/bfi_chinese-adaptation_clean.csv")
...
write_lines(esem_specs,
            paste("output/ffm-esem/bfi_chinese-adaptation_esem-syntax.txt",
                  sep = ""))
...
if (esem_model@optim$converged == TRUE) {
  ...
  write_rds(esem_std,
            paste("output/ffm-esem/bfi_chinese-adaptation_esem-std-solution.rds",
                  sep = ""))
...
write_csv(esem_data, "output/bfi_chinese-adaptation_esem-model-fit.csv")
...
write_lines(esem_specs,
            paste("output/ffm-esem/bfi_chinese-adaptation_uc-esem-syntax.txt",
                  sep = ""))
...
if (esem_model@optim$converged == TRUE) {
  ...
  write_rds(esem_std,
            paste("output/ffm-esem/bfi_chinese-adaptation_uc-esem-std-solution.rds",
                  sep = ""))
...
write_csv(esem_uc_data, "output/bfi_chinese-adaptation_uc-esem-model-fit.csv")
