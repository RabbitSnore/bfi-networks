...
write_lines(esem_specs,
            paste("output/ffm-esem/bfi_us-validation_esem-syntax.txt",
                  sep = ""))
...
if (esem_model@optim$converged == TRUE) {
  ...
  write_rds(esem_std,
            paste("output/ffm-esem/bfi_us-validation_esem-std-solution.rds",
                  sep = ""))
...
write_csv(esem_data, "output/bfi_us-validation_esem-model-fit.csv")
...
write_lines(esem_specs,
            paste("output/ffm-esem/bfi_us-validation_uc-esem-syntax.txt",
                  sep = ""))
...
if (esem_model@optim$converged == TRUE) {
  ...
  write_rds(esem_std,
            paste("output/ffm-esem/bfi_us-validation_uc-esem-std-solution.rds",
                  sep = ""))
...
write_csv(esem_uc_data, "output/bfi_us-validation_uc-esem-model-fit.csv")
