...
big_five_target_loadings <- list(
  e = paste("item", 1:8,   sep = ""),
  a = paste("item", 9:16,  sep = ""),
  c = paste("item", 17:24, sep = ""),
  n = paste("item", 25:32, sep = ""),
  o = paste("item", 33:40, sep = "")
)
...
write_lines(esem_specs,
            paste("output/ffm-esem/bfi_cbf_esem-syntax.txt",
                  sep = ""))
...
if (esem_model@optim$converged == TRUE) {
  ...
  write_rds(esem_std,
            paste("output/ffm-esem/bfi_cbf_esem-std-solution.rds",
                  sep = ""))
...
write_csv(esem_data, "output/bfi_cbf_esem-model-fit.csv")
...
write_lines(esem_specs,
            paste("output/ffm-esem/bfi_cbf_uc-esem-syntax.txt",
                  sep = ""))
...
if (esem_model@optim$converged == TRUE) {
  ...
  write_rds(esem_std,
            paste("output/ffm-esem/bfi_cbf_uc-esem-std-solution.rds",
                  sep = ""))
...
write_csv(esem_uc_data, "output/bfi_cbf_uc-esem-model-fit.csv")
